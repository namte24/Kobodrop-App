    ...
    <section className="bg-gray-800 ">
      <div className=" flex max-w-7xl flex-col px-8 py-12 text-gray-300 lg:px-12 xl:m-auto">
        <div className="flex flex-col justify-between gap-12 md:flex-row md:gap-0">
          <div>
            <img className="mb-4 w-36" src={KobodropLight} alt="Lightversion" />
            <p>Start spending the right way.</p>
          </div>
          <div className="flex gap-10">
            <div className="flex flex-col gap-2">
              <p className="text-gray400">Product</p>
              <a href="#">Overview</a>
              <a href="#">Features</a>
              <a href="#">Solutions</a>
              <a href="#">Contact</a>
            ...
            <div className="flex flex-col gap-2">
              <p className="text-gray400">Resources</p>
              <a href="#">Blog</a>
        ...
        <div className="mt-14 flex justify-between border-t-2 border-t-gray-700 pt-10">
          ...
          <div className="flex gap-6">
            ...
            <a href="https://linkedin.com" target="_blank">
              <img src={LinkedIn} alt="twitterlogo" />
            </a>
          </div>
        </div>
      </div>
